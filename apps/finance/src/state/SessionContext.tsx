...
/**
 * Gleiches Session-Muster wie apps/office (httpOnly-Cookie, kein
 * localStorage-Auth). Finance/Geschäftsführung-Konten benötigen ebenfalls
 * abgeschlossenes MFA (siehe apps/api auth.test.ts) – das TOTP-Feld wird bei
 * Bedarf angezeigt.
 */
