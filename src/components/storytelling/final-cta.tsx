 ...
 * up the phone. The chapter that ends a climb into daylight ends on daylight
 * footage — the one clip in the archive shot outside a dark studio.
 */
export function FinalCta() {
  return (
    <section className="chapter-day relative isolate overflow-hidden py-28 md:py-36" data-atmo="80/75">
      <SceneVideo name={sceneClips.dayRoad.name} hd={sceneClips.dayRoad.hd} className="arrival-film" />
      ...
      <Image
        ...
        width={700}
        height={254}
        className="pointer-events-none absolute left-1/2 top-8 z-0 w-[34rem] max-w-[90vw] -translate-x-1/2 opacity-[0.07] mix-blend-multiply"
      />

      <div className="shell relative z-10">
        <div className="arrival-card mx-auto max-w-[46rem] rounded-3xl px-6 py-12 text-center sm:px-12">
